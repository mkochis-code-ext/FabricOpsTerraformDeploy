...
variable "workspace_display_name" {
  description = "Display name of the Prod Fabric workspace."
  type        = string
  default     = "FabricOps-Prod"
}

variable "workspace_description" {
  description = "Description of the Prod Fabric workspace."
  type        = string
  default     = "Production workspace managed by Terraform."
}
